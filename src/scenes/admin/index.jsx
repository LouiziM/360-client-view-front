                    ...
                    <Paper sx={{ p: 4, boxShadow: 'none' }}>
                        <Box component={"form"} onSubmit={editUser ? handleSubmitEdit : handleSubmit}>
                            <Grid container spacing={3}>
                                ...
                                {!editUser ? (
                                    <Grid item xs={12} md={2} sm={6}  sx={{ display: 'flex', flexDirection: 'row' }}>
                                       <Box mr={4}>
                                       <FormControl sx={{marginTop:"19px"}} >
                                        ...
                                        <Button
                                            ...
                                            sx={{
                                                marginTop: '20px',
                                                height: '50px', minWidth: '160px', backgroundColor: theme.palette.secondary.light, fontWeight: 'bold'
                                            }}
                                        >
                                            Ajouter
                                        </Button>
