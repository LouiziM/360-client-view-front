                    ...
                    <Grid container>
                        <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                            <Box gap={2} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', height: '100%' }}>
                                <Typography title="Tél"  sx={{ display: 'flex', alignItems: 'center' }} onClick={() => copyToClipboard(`${data.PHONE}`)}>
                                    <PhoneIcon sx={{ marginRight: '.7rem' }} />
                                    {data?.PHONE}
                                </Typography>
                                <Typography title="Email"  sx={{ display: 'flex', alignItems: 'center' }} onClick={() => copyToClipboard(`${data.EMAIL}`)}>
